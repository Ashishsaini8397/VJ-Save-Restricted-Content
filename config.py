...
API_ID = int(os.environ.get("API_ID", "25214196"))

# Your API Hash from my.telegram.org
API_HASH = os.environ.get("API_HASH", "86d48fc757225565a261b2c35dded762")

# Your Owner / Admin Id For Broadcast 
ADMINS = int(os.environ.get("ADMINS", "5507871254"))
...
CHANNEL_ID = os.environ.get("CHANNEL_ID", "1002417307229")

# Your Mongodb Database Url
# Warning - Give Db uri in deploy server environment variable, don't give in repo.
DB_URI = os.environ.get("DB_URI", "mongodb+srv://jejag57112:uf166gGmyuwtEZpL@cluster0.iwzb1.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
